                                        ...
                                        <form action="changePwd.php" method="POST">
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="currPwd" class=" form-control-label">Current Password</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="password" id="currPwd" name="currPwd" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="newPwd" class=" form-control-label">New Password</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="cnewPwd" class=" form-control-label">Confirm New Password</label>
                                                </div>
                                                <div class="col-12 col-md-9">
