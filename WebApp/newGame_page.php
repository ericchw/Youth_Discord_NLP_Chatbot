                                        ...
                                        <form action="addGame.php" method="POST">
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="engName" class=" form-control-label">English Name</label>
                                                </div>
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="zhName" class=" form-control-label">中文名</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="zhName" name="zhName" class="form-control">
                                                </div>
                                            </div>
